...
{
    public partial class frm_Configurador_S3 : Form
    {
        // string teste;
        private frm_Mapa_Jan_Borracha newForm { get; set; }
        ...
        string _xml_opcao = @"S:\Cad.Minibuss\CONFIGCAD_2014_MRP\DLL\NX\MICRO_S3\xml_opcoes_S3.xml";

        
        public frm_Configurador_S3()
        {
            InitializeComponent();
        ...
        private void btn_import_dna_Click(object sender, EventArgs e)
        {
           ...
           // XElement xml = XElement.Load(_xml_opcao);
            ...
            lista_opcoes = xmlBiblioteca.SelectNodes("/Opcoes_micro_S3/Opcao");
            ...
            string path = @"S:\Cad.Minibuss\CONFIGCAD_2014_MRP\DLL\NX\MICRO_S3\DNA\" + txt_fm_dna.Text + ".xml";
            ...
            NORMA = dtg_view_dna.Rows[0].Cells[1].Value.ToString();
            CHASSI = dtg_view_dna.Rows[2].Cells[1].Value.ToString();
            SUSP = dtg_view_dna.Rows[3].Cells[1].Value.ToString();
            COMP =dtg_view_dna.Rows[4].Cells[1].Value.ToString();
            EE = dtg_view_dna.Rows[5].Cells[1].Value.ToString();
            PORTA_CENTRAL = dtg_view_dna.Rows[6].Cells[1].Value.ToString();
            PORTA_TRAS = dtg_view_dna.Rows[7].Cells[1].Value.ToString();
            MODELO_AC = dtg_view_dna.Rows[9].Cells[1].Value.ToString();
            QTD_ALCAPAO = dtg_view_dna.Rows[10].Cells[1].Value.ToString();
            PORTA_PAC = dtg_view_dna.Rows[11].Cells[1].Value.ToString();
            VIGIA_TRAS = dtg_view_dna.Rows[13].Cells[1].Value.ToString();
            MODELO_JAN = dtg_view_dna.Rows[14].Cells[1].Value.ToString();
            MODELO_JAN_MOT = dtg_view_dna.Rows[15].Cells[1].Value.ToString();
            BAG_EE = dtg_view_dna.Rows[16].Cells[1].Value.ToString();
            ESCAP = dtg_view_dna.Rows[17].Cells[1].Value.ToString();
            PORTA_ESTEPE = dtg_view_dna.Rows[19].Cells[1].Value.ToString();
            P_BALSA = dtg_view_dna.Rows[20].Cells[1].Value.ToString();
            ILUMICACAO = dtg_view_dna.Rows[22].Cells[1].Value.ToString();
            CURVA_TETO = dtg_view_dna.Rows[24].Cells[1].Value.ToString();

            if (System.IO.File.Exists(@"c:\temp\jan.txt"))
                {
                System.IO.File.Delete(@"c:\temp\jan.txt");
                }
                string gLog_FileName = @"c:\temp\jan.txt";
                System.IO.StreamWriter vWriter = new System.IO.StreamWriter(gLog_FileName, true, System.Text.Encoding.Unicode);
                vWriter.WriteLine(MODELO_JAN);
                vWriter.Close();
            ...
            if ((CHASSI == "MBB LO-916 PODEST AVANCADO" || CHASSI == "MBB LO-916 PODEST RECUADO") && EE == "4300")
            {
        ...
        {
             XmlDocument xmlBiblioteca = new XmlDocument();
            xmlBiblioteca.Load(@"S:\Cad.Minibuss\CONFIGCAD_2014_MRP\DLL\NX\MICRO_S3\xml_dados_S3.xml");
            ...
            Lista_Opçoes = xmlBiblioteca.SelectNodes("/Dados_S3/Dados");
        ...
        private void Configurar()
        {
           ...
           //            + POS_TQ + "   POS_BATERIAS: " + POS_CX_BATERIA + "   POS_ESTEPE: " + POS_ESTEPE);
            ...
            try
            {
                ...
                if (QTD_ALCAPAO == "3.4.12 - Dois de Emergência no Teto com Ventilador Acoplado")
                {
            ...
            catch (Exception)
            {
             ...
             try
             {
                 Expression expression25 = (Expression)workPart.Expressions.FindObject("PORTA_CENTRAL");
                 string porta_central_value = "\"" + PORTA_CENTRAL + "\"";
                 workPart.Expressions.EditWithUnits(expression25, null, porta_central_value);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression26 = (Expression)workPart.Expressions.FindObject("PORTA_TRASEIRA");
                 string PORTA_TRASEIRA_value = "\"" + PORTA_TRAS + "\"";
                 workPart.Expressions.EditWithUnits(expression26, null, PORTA_TRASEIRA_value);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression27 = (Expression)workPart.Expressions.FindObject("POS_PORTA_TRASEIRA");
                 string POS_PORTA_TRASEIRA_value = "\"" + POS_PORTA + "\"";
                 workPart.Expressions.EditWithUnits(expression27, null, POS_PORTA_TRASEIRA_value);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression28 = (Expression)workPart.Expressions.FindObject("PORTA_PACOTES");
                 string porta_pac = "\"" + PORTA_PAC + "\"";
                 workPart.Expressions.EditWithUnits(expression28, null, porta_pac);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression28 = (Expression)workPart.Expressions.FindObject("ESCAPAMENTO");
                 string escape = "\"" + ESCAP + "\"";
                 workPart.Expressions.EditWithUnits(expression28, null, escape);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression28 = (Expression)workPart.Expressions.FindObject("ILUMINACAO");
                 string ilumi = "\"" + ILUMICACAO + "\"";
                 workPart.Expressions.EditWithUnits(expression28, null, ilumi);
             }
             catch (Exception)
             {
             ...
             try
             {
                 Expression expression28 = (Expression)workPart.Expressions.FindObject("CURVA_TETO");
                 string curva = "\"" + CURVA_TETO + "\"";
                 workPart.Expressions.EditWithUnits(expression28, null, curva);
             }
             catch (Exception)
             {
            ...
            foreach (Expression exp in workPart.Expressions)
            {
                ...
                if (exp.Name == "MAPA_JANELA_C_BORRACHA")//IT_CONFIG
                {
                    this.WindowState = FormWindowState.Minimized;
                    frm_Mapa_Jan_Borracha frm = new frm_Mapa_Jan_Borracha();
        ...
        {
            //string abrir = Codificar.Codificar_item("");
          
            //MessageBox.Show("Codificação Finalizada","INFORMAÇÕES", MessageBoxButtons.OK, MessageBoxIcon.Information );
        }
