...
namespace Custom_Mascarello
{
    class Search_Tubos
    {
        ...
        public static string SearchMember(string fam, string Inicio_DB_PART_NAME, string[] Expressao, double[] valor_expressao, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao, string material)
        {
            ...
            try
            {
                ...
                arquivo_substituto = Localizar_Membro_da_Familia(encoded_familia, Inicio_DB_PART_NAME, Expressao, valor_expressao, Nr_Attr_Concatenar_Nome, Tolerancia, Cod_DataSul, descricao, material); 
