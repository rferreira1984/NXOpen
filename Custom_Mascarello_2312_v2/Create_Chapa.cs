...
{   
    class Create_Chapas
    {
        ...
        public static string CreateMember(string fam, string Inicio_DB_PART_NAME, string[] Expressao, double[] valor_expressao, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao)
        {
            ...
            try
            {
                ...
                arquivo_substituto = Localizar_Membro_da_Familia(encoded_familia, Inicio_DB_PART_NAME, Expressao, valor_expressao, Nr_Attr_Concatenar_Nome, Tolerancia, Cod_DataSul, descricao, fam); 
        ...
        public static string CreateMember_material(string fam, string Inicio_DB_PART_NAME, string[] Expressao, double[] valor_expressao, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao, string material)
        {
            ...
            try
            {
                ...
                arquivo_substituto = Localizar_Membro_da_Familia_material(encoded_familia, Inicio_DB_PART_NAME, Expressao, valor_expressao, Nr_Attr_Concatenar_Nome, Tolerancia, Cod_DataSul, descricao, material, fam);
        ...
        public static string Localizar_Membro_da_Familia(string Familia, string Inicio_DB_PART_NAME, string[] Atributo, double[] Valor, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao, string fam)
        {
                ...
                try
                {
                    ...
                    */
                    ...
                    if (!Membro_Ja_Existe)
                    {
                        ...
                        Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) Nenhum Item Encontrado.");
                        ...
                        while (flg) // inicio LOOPING 
                        {
                            try
                            {
                                ...
                                //if (Cod_DataSul == "")// verifica se o campo código atual  está vazio, se verdadeiro então busca codigo
                                //{
                        ...
                        new_member_data.values[1] = item_id;
                        ...
                        if (DB_PART_NAME != "")
                            new_member_data.values[2] = DB_PART_NAME;
                        ...
                        for (int k = 0; k < Atributo.Length; k++)
                        {
                            ...
                            //Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) aux_valor:" + aux_valor);
        ...
        public static string Localizar_Membro_da_Familia_material(string Familia, string Inicio_DB_PART_NAME, string[] Atributo, double[] Valor, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao, string material, string fam)
        {
