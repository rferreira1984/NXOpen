    ...
    class Search
    {
        ...
        public static string CreateMember(string fam, string Inicio_DB_PART_NAME, string[] Expressao, double[] valor_expressao, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_Atual, string descricao)
        {
            ...
            try
            {
                ...
                arquivo_substituto = Localizar_Membro_da_Familia(encoded_familia, Inicio_DB_PART_NAME, Expressao, valor_expressao, Nr_Attr_Concatenar_Nome, Tolerancia, Cod_Atual, descricao);
        ...
        public static string Localizar_Membro_da_Familia(string Familia, string Inicio_DB_PART_NAME, string[] Atributo, double[] Valor, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_Atual, string descricao)
        {
            bool flg1 = true;
            string membro = "";
            while (flg1)
            {
               ...
               //     bool verfificar
                        ...
                        {   
                            ...
                            {   
                                ...
                                if (resultado <= Tolerancia[j])
                                {
                                    ...
                                    membro = member_data.values[0]+"/"+member_data.values[4];
                                }
                                else
                                {
                    ...
                    */
                    ...
                    if (!Membro_Ja_Existe)
                    {
                        Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) item não Encontrado:");
                        membro = "";
                    }
           ...
           /// System.Windows.Forms.MessageBox.Show(membro);
            return membro;
        }
    }
}
