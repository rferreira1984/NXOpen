...
{   
    class Create_Tubos
    {
        ...
        public static string CreateMember(string fam, string Inicio_DB_PART_NAME, string[] Expressao, double[] valor_expressao, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao, string material)
        {
            ...
            try
            {
                ...
                arquivo_substituto = Localizar_Membro_da_Familia(encoded_familia, Inicio_DB_PART_NAME, Expressao, valor_expressao, Nr_Attr_Concatenar_Nome, Tolerancia, Cod_DataSul, descricao, material, fam); 
        ...
        public static string Localizar_Membro_da_Familia(string Familia, string Inicio_DB_PART_NAME, string[] Atributo, double[] Valor, int Nr_Attr_Concatenar_Nome, double[] Tolerancia, string Cod_DataSul, string descricao,string material, string fam)
        {
            bool flg1 = true;
            string membro = " ";
            while (flg1)
                ...
                try
                {
                    ...
                    */
                    ...
                    if (!Membro_Ja_Existe)
                    {
                        ...
                        new_member_data.values[10] = material;
                        ...
                        if (DB_PART_NAME != "")
                            new_member_data.values[1] = DB_PART_NAME;
                        ...
                        Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) Update em :" + Convert.ToString(item_id));
        ...
        public static string Lista_Membro_da_Familia(string Familia)
        {
            bool flg1 = true;
            string membro = " ";
            ...
            //    try
            //    {
            Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) Abrindo Familia:" + encoded_familia);
                    PartLoadStatus LdSt;
                    Part obj_familia;
                   ...
                   // int[] att_idx = new int[Atributo.Length];
                    ...
                    for (j = 0; j < attr.Length; j++)
                    {
                        ...
                        Registrar_no_LOG(" DEBUG -> (aaaaaaaaaaaaaLocalizar_Membro_da_Familia) " + attr);
                        //for (int i = 0; i < Atributo.Length; i++)
                        //    if (Atributo[i] == atb)
                        //    {
                        //        Registrar_no_LOG(" DEBUG -> (Localizar_Membro_da_Familia) " + Atributo[i] + " Index: " + j.ToString());
