...
{   
    class Create_Tubos_cnc
    {
        ...
        {
          //  theUI.NXMessageBox.Show("UI Styler", NXMessageBox.DialogType.Error, "AAAA");
            ...
            while (flg1)
            {
              //   theUI.NXMessageBox.Show("UI Styler", NXMessageBox.DialogType.Error, flg1.ToString());
                try
                {
                  ...
                  //  obj_familia.IsReadOnly.
                    ...
                    */
                    ...
                    if (!Membro_Ja_Existe)
                    {
                        ...
                        while (flg) // inicio LOOPING 
                        {
                            try
                            {
                                ...
                                if (Cod_DataSul == "")// verifica se o campo código atual  está vazio, se verdadeiro então busca codigo
                                {
                                    ...
                                    item_id = partbuilder.AssignPartNumber("M4_it_cv");
                        ...
                        new_member_data.values[3] = "M4_it_cv";
