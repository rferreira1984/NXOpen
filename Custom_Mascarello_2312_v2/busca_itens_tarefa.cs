...
{
    public class busca_itens_tarefa
    {
        public static string SHA1(string strPlain)
        {
        ...
        public static string busca_tarefas(string fm)
        {
            string messagem = "";
            using (var client = new WebClient())
            {

                //string gera_tokem1 = "SPOL+SIM" + System.DateTime.Now.ToString("yyyy-MM-dd");
                ...
                var response = client.UploadValues("http://extranet.mascarello.com.br/sim/webhook/spol/getTarefasPedido/", values);
